...
# https://www.microsoft.com/de-de/p/deutsch-local-experience-pack/9nwvgwlhpb1z
...
# https://bspmts.mp.microsoft.com/v1/public/catalog/Retail/Products/9nwvgwlhpb1z/applockerdata
#$packageFamilyName = 'Microsoft.LanguageExperiencePackde-DE_8wekyb3d8bbwe' # Spanish
