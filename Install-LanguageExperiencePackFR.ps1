...
# https://www.microsoft.com/de-de/p/deutsch-local-experience-pack/9nhmg4bjkmdg
$applicationId = "9nhmg4bjkmdg" # French
...
# https://bspmts.mp.microsoft.com/v1/public/catalog/Retail/Products/9nhmg4bjkmdg/applockerdata
#$packageFamilyName = 'Microsoft.LanguageExperiencePackde-DE_8wekyb3d8bbwe' # French
...
$inputLanguageID = "040c:0000040c" # fr-FR
