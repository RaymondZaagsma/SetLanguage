...
# https://www.microsoft.com/de-de/p/deutsch-local-experience-pack/9pf1c9nb5prv
...
# https://bspmts.mp.microsoft.com/v1/public/catalog/Retail/Products/9pf1c9nb5prv/applockerdata
#$packageFamilyName = 'Microsoft.LanguageExperiencePackde-DE_8wekyb3d8bbwe' # Dutch
...
$inputLanguageID = "0413:00020409" # NL-NL
